--------------------------------------------------------------------------------
-- Nav_Aggregate_Practice Component Implementation Spec
--------------------------------------------------------------------------------
...
-- Wraps navAggregateAlgorithm to compute aggregated navigation state from
-- multiple navigation message inputs.
package Component.Nav_Aggregate_Practice.Implementation is

   -- The component class instance record:
   type Instance is new Nav_Aggregate_Practice.Base_Instance with private;

private

   -- The component class instance record:
   type Instance is new Nav_Aggregate_Practice.Base_Instance with record
      null; -- TODO
   end record;
   ...
   overriding function Validate_Parameters (
      ...
      Att_Time_Idx : in Packed_U32.U;
      Trans_Time_Idx : in Packed_U32.U;
      Att_Idx : in Packed_U32.U;
      Rate_Idx : in Packed_U32.U;
      Pos_Idx : in Packed_U32.U;
      Vel_Idx : in Packed_U32.U;
      Dv_Idx : in Packed_U32.U;
      Sun_Idx : in Packed_U32.U;
      Att_Msg_Count : in Packed_U32.U;
      Trans_Msg_Count : in Packed_U32.U
